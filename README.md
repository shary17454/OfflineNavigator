...
| **رواية (Codex platform)** | `rawayah/` | Heritage monorepo from `my-codex` (Nest/Next/Flutter) |
| **رواية (SwiftUI offline)** | `Riwaya.xcodeproj` | Native iOS offline writing/reading companion |

See [`docs/RAWAYA_MERGE.md`](docs/RAWAYA_MERGE.md) and [`rawayah/README.md`](rawayah/README.md).
